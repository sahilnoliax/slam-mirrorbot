...
def start(update, context):
    start_string = f'''
This bot is created by Sahil Nolia
'''
    buttons = button_build.ButtonMaker()
    buttons.buildbutton("Admin", "https://t.me/sahil_nolia")
    ...
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        ...
        sendMessage(f"This Bot Is Only For Authorized user.", context.bot, update)
